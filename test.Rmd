...
```{r}
oplsda <- metabom8::opls(BIOspcglyc[,1:8], BIOspcglyc$covid_status, maxPCo = 2, cv = list(method = "MC",k = 112, split = 2/3), plotting=TRUE) 
 plotscores(oplsda) 
 pcA <- metabom8::pca(BIOspcglyc[,1:8], pc=2)
 plotload_cat(pcA, an=list(colnames(BIOspcglyc[ ,1:8])))
