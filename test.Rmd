...
b<- plotinput(screecumulativethresholdobject = output, CO = "covid_status", SH = "sex", SZ = "age", AL = 0.4)
...
pcagrid(screecumulativethresholdobject = output, CO = "covid_status", SZ = "age", COtitle = "covid", SZtitle = "Age")
...
pcagrid(screecumulativethresholdobject = output, CO = "covid_status", SZ = 0.5, AL = 1, COtitle = "covid", SZtitle = "Age")
...
pcagridlegend(screecumulativethresholdobject = output, x = "PC1", y = "PC2", CO = "covid_status", SH="sex", AL="age", SZ=1, COtitle = "COV", SHtitle= "gender", SZtitle=NULL, ALtitle="Age")
```
